...
<body>
			...
			<tr style="background:#33ff00" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td><input type="checkbox" name="checked_goods" value="${item.goods_id }"  onClick="calcGoodsPrice(${item.goods_sales_price },this)"></td>
					...
					<td>
					   <%-- <strong>
				         ...
				         <strong>${item.goods_sales_price}원(10%할인)</strong>
					</td>
					<td>
					   <input type="text" id="cart_goods_qty" name="cart_goods_qty" size=3 value="${cart_goods_qty}"><br>
						...
						<input type="hidden" id="cart_goods_id" name="cart_goods_id" value="${item.goods_id }">
					</td>
					<td>
					   <strong>
	...
	<center>
	<br>	
		 <a href="javascript:fn_order_cart_goods(${myGoodsList.size() })">
