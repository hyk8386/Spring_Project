		...
		<DIV class="tab_container">
			...
			<tr >
				...
				<td width=500>
				  <select name="goods_sort">
					<c:choose>
				      <c:when test="${goods.goods_sort=='텐트/타프' }">
						<option value="텐트/타프" selected>텐트/타프
						<option value="침낭/매트">침낭/매트
						<option value="테이블/의자">테이블/의자
						<option value="주방/그릴">주방/그릴
						<option value="캠핑가전">캠핑가전
						<option value="랜턴">랜턴
				  	  </c:when>
				  	  <c:when test="${goods.goods_sort=='침낭/매트' }">
						<option value="텐트/타프" >텐트/타프
						<option value="침낭/매트" selected>침낭/매트
						<option value="테이블/의자">테이블/의자
						<option value="주방/그릴">주방/그릴
						<option value="캠핑가전">캠핑가전
						<option value="랜턴">랜턴
			...
			<tr>
				...
				<select name="goods_status">
				  <option value="bestseller"  >PRODUCT</option>
...
<%-- 			
			...
			<DIV class="tab_content" id="tab4">
				...
				<table>
					<tr>
						<!-- <td>상품소개</td> -->
						<td><textarea  name="goods_intro" class="autosize" onkeydown="resize(this)" onkeyup="resize(this)" placeholder="추가 바람">
						${goods.goods_intro }
						</textarea>
						</td>
					</tr>
