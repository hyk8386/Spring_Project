...
public interface OrderController {
	...
	public ModelAndView orderAllCartGoods(@RequestParam  String[] cart_goods_qty, @RequestParam String[] cart_goods_id, HttpServletRequest request, HttpServletResponse response)  throws Exception;
